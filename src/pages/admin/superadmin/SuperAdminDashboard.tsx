...
//         fetch(`${API_URL}/leads/stats/all`),
//         fetch(`${API_URL}/leads`),
//         fetch(`${API_URL}/projects`)
//       ]);
      
//       const [statsData, leadsData, projectsData] = await Promise.all([
//         statsRes.json(),
//         leadsRes.json(),
//         projectsRes.json()
//       ]);
...
//     try {
//       // Note: Add DELETE endpoint in your backend if not exists
...
//                 icon={Users}
//                 color="border-blue-500" trend={undefined}              />
//               <StatCard 
//                 title="New Leads"
//                 value={stats.newLeads}
//                 icon={FileText}
//                 color="border-yellow-500" trend={undefined}              />
//               <StatCard 
//                 title="Pending Leads" 
//                 value={stats.pendingLeads} 
//                 icon={Clock}
//                 color="border-orange-500" trend={undefined}              />
//               <StatCard 
//                 title="Consulted Leads" 
//                 value={stats.consultedLeads} 
//                 icon={CheckCircle}
//                 color="border-green-500" trend={undefined}              />
//             </div>
