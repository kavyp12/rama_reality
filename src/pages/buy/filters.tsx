...
//     );
// };
// // Replace the FlatCard component with this updated version
...
//     return (
//         <div className="bg-white rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 overflow-hidden border border-gray-100 flex flex-col sm:flex-row h-[290px]">
//             {/* Image Section */}
//             <div className="sm:w-2/5 relative h-48 sm:h-full flex-shrink-0">
